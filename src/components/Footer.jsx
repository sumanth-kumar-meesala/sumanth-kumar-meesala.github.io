  ...
  return (
    <footer className="relative mt-16 border-t border-white/10 bg-[#030014]">
      ...
      <div className="container mx-auto px-6 py-12 flex flex-col items-center">
        ...
        >
          <div className="flex items-center justify-center w-full h-full glass-card rounded-full rounded-full bg-surface/80">
        ...
        <p className="text-slate-500 text-sm">
          &copy; {new Date().getFullYear()} Sumanth Kumar Meesala. All rights reserved.
        </p>
      </div>
    </footer>
  );
